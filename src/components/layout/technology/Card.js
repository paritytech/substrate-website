...
const Card = ({ page, delay, mode, image }) => {
  ...
  return (
    <Link to={link} data-aos="fade-up" data-aos-delay={delay ? delay : 0}>
      ...
      >
        <div className="self-center md:order-2 w-1/3 md:w-full lg:w-1/2 pt-8 pl-8 md:p-8 lg:p-0 justify-self-end lg:flex-none">
          <Icon name={image} className={cx('md:w-full h-auto', { 'lg:mb-6': mode === 'vertical' })} />
        </div>
        <div className="flex flex-col lg:w-2/3 lg:flex-none justify-between p-8 pt-2 md:pt-8 lg:pr-4 md:order-1">
