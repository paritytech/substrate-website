...
const CaseStudyFilter = ({ showCaseStudies, setShowCaseStudies }) => {
  return (
    <div className="flex case-studies dark:bg-darkBackground border py-2 px-3 lg:justify-center justify-start items-center hover:cursor-pointer lg:mb-0 md:mb-4 sm:mb-4 xs:mb-4">
