  ...
  return (
    ...
    >
      <div className="flex">
        ...
        <svg
          className={`w-44 h-10 ml-3 fill-current dark:text-substrateDark text-substrateWhite`}
      ...
      <p className="mb-0 leading-6 underline-animate underline-animate-thin">
        The Substrate community is campaigning for a dedicated{' '}
        <b>
        ...
        <br />
        <b>
          Please help us by following and upvoting questions to a score of 10{' '}
